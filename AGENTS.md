...
This project is indexed by GitNexus as **agentic-inbox** (4028 symbols, 7616 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agentic-inbox/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agentic-inbox/clusters` | All functional areas |
| `gitnexus://repo/agentic-inbox/processes` | All execution flows |
| `gitnexus://repo/agentic-inbox/process/{name}` | Step-by-step execution trace |
